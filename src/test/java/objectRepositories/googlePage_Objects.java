...
public class googlePage_Objects extends Utility{
	...
	public boolean validateJPMCLogo() throws InterruptedException {
		lnk_Jpmorggan.click();
		WebDriverWait wait = new WebDriverWait(driver, 30);
		By verfiy_logo = By.xpath("//div[@class='logoContainer']/a");
		wait.until(ExpectedConditions.visibilityOfElementLocated(verfiy_logo));
		boolean is_LogoDisplay = false;
		try{
			is_LogoDisplay = verify_Jpmclogo.isDisplayed();;
		}catch(NoSuchElementException e){
			System.out.println("Element is not displayed");
		}
 		return is_LogoDisplay;
